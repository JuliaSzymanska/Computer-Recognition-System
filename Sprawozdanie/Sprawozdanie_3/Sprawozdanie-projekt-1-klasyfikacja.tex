...
\begin{itemize}
  \item Dokładność (ang. accuracy), ACC  - jest to stopień zgodności wartości ze średnią arytmetyczną uzyskanych wyników. \begin{equation}\begin{array}{l} ACC = (TP + TN)/(TP + FN + FP + TN) \\
ACC = \frac{liczba \ poprawnie\ zaklasyfikowanych\ tekstow}{liczba klasyfikowanych tekstów}  \end{array}\end{equation}
