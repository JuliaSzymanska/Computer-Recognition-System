...
\begin{enumerate}
  \item Liczba słów 
  \item Druga najczęściej występująca waluta
  \item Data z tagu  \textless Dateline\textgreater
  \item Lokacja z tagu \textless Dateline\textgreater
  \item Tytuł 
  \item Autor
  \item Najczęściej występująca nazwa kraju
  \item Nasycenie tekstu ilością słów kluczowych
  \item Ilość wystąpień słów kluczowych
