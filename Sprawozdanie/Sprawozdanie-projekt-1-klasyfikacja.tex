...
Celem projektu jest stworzenie aplikacji klasyfikującej zbiór danych tekstowych metodą K najbliższych sądziadów (k-NN). W pierwszej fazie aplikacji należy wykonać ekstrakcję cech z otrzymanych zbiorów tekstów. W ostatniej fazie aplikacji należy wykonać klasyfikację tekstów.  (wplyw parametrów na jakość klasyfikacji?)\\
...
Polega na zaklasyfikowaniu rozpatrywanego elementu do zbioru ze zbioru uczącego, który najczęściej występuje w promieniu k od rozpatrywanego elementu. Klasyfikator przyjmuje cztery parametry wejściowe takie jak: warotść k - promień obszaru rozpatrywanego, proporcje podziału zbiorów na zbior uczący i zbiór testowy, zbiór cech, a także metrykę i/lub miarę prawdopodobieństwa. Wynikiem klasyfikacji jest zaklasyfikowanie elementu do jednego ze zbiorów uczących. 
