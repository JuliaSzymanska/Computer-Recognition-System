...
\begin{enumerate}
  ...
  \item Data z tagu  \textless Dateline\textgreater\ - Większość tekstów w swoim body posiada tag \textless Dateline\textgreater , w którym w większości przypadków znajduje się miasto oraz data podana w postaci miesiąca i dnia.
  \item Lokacja z tagu \textless Dateline\textgreater - jak wyżej. Lokację traktujemy jako cechę tekstową.
  \item Tytuł 
  \item Autor
  \item Najczęściej występująca nazwa kraju - wybieramy najczęściej występującą w analizowanym tekscie nazwę kraju.
  ...
  \item Najczęściej występujące słowo kluczowe
