...
\begin{figure}[h!]
 ...
 \vspace{-0.3cm}
 \caption{Wykres funkcji przynależności kwantyfikatorów lingwistycznych. }
 \label{rysunek do eksperymentu 1 wariantu 1}
\end{figure}
\newpage

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Do kwantyfikatora lingwistycznego absolutnego zostały dopasowane etykiety: poniżej dziesięciu, około pięćdziesięciu, około stu, między sto a dwieście, około dwustu, ponad dwieście. 
