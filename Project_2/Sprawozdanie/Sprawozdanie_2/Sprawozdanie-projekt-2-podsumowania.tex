...
%\begin{equation}
%\mu _{severity}(x) =  \left\{ \begin{array}{rcl}
%0 & \mbox{dla} & x = 1 \\
%\frac{x - 1}{3} & \mbox{dla} & x  \epsilon \{2, 3, 4\}\\
%\end{array}\right.
%\end{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Widoczność powietrza w momencie wypadku, zmienna lingwistyczna przedstawiona wraz z etykietami w formie wykresu funkcji przynelażności oraz wzorów analitycznych:
\begin{equation}
