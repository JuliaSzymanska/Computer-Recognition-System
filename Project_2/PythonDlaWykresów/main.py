...
def draw_absolute_quantificators():
    ...
    plt.plot([200, 250, 300, 350], [0, 1, 1, 0], label="Ponad 200")
    plt.plot([300, 400, 600, 700], [0, 1, 1, 0], label="Około 500")
    plt.plot([600, 800, 1200, 1400], [0, 1, 1, 0], label="Około 1000")
    plt.plot([1200, 1600, 2400, 2800], [0, 1, 1, 0], label="Około 2000")
    plt.plot([2400, 2800, 4200, 4600], [0, 1, 1, 0], label="Około 3500")
